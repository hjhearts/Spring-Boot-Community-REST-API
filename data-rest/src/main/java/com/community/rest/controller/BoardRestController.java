...
public class BoardRestController {
    ...
    public ResponseEntity<?> putBoard(@PathVariable("idx") Long idx, @RequestBody Board board){
        System.out.println("PUT METHOD ACTIVATED");
    ...
    public ResponseEntity<?> getCorona() throws UnsupportedEncodingException,  URISyntaxException {
        ...
        urlBuilder.append("?")
                ...
                .append("=")
                .append(URLDecoder.decode(URLEncoder.encode("bzHeLyHn1eU7Zd0Vcw3%2BB8UWymKAxuQxo%2Fq5la9XlJvHKOStYuIySV44whfV17WSKlJWWE8EyP5x6vWsRxpEdg%3D%3D", "UTF-8"), "UTF-8"));
